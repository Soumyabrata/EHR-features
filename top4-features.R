...
datamatrix_case1 = data_without_id[,c("age","heart_disease","avg_glucose_level", "hypertension", "stroke")]
...
# Neural network method on top 4 features

file_name <- './results/top4originalfeatures_neuralnetwork.csv'
...
for (i in 1:no_of_exps) {
  ...
  # Output labels
  out_labels<-as.data.frame(test_set[, 5])
...
# Decision tree method on top 4 features

dtree_result = c()

file_name <- './results/top4originalfeatures_decisiontree.csv'
cat(c("Experiment-number,", "TP,", "FN,", "FP,", "TN,", "Precision,", "Recall,", "F-score,","Accuracy,", "Miss-rate,", "Fall-out-rate"),file=file_name)
cat("\n",file=file_name,append=TRUE)
...
# Random forest method on top 4 features

rforest_result = c()
file_name <- './results/top4originalfeatures_randomforest.csv'
cat(c("Experiment-number,", "TP,", "FN,", "FP,", "TN,", "Precision,", "Recall,", "F-score,","Accuracy,", "Miss-rate,", "Fall-out-rate"),file=file_name)
cat("\n",file=file_name,append=TRUE)
...
# Figure 4
pdf('./results/distribution-4features.pdf',width=6,height=4,paper='special')
...
# saving the df
write.csv(df, file = "./results/top4features_myresults.csv")
